...
export default function Timer({
  ...
  const { currentStep, stepName, maxStep } = useSelector(
  ...
  const completeStep = async () => {
    ...
    animatedOrbitRadius.value = withTiming(innerRadius - 10, {
      duration: 500,
      easing: Easing.inOut(Easing.ease),
    });
    setPlaying(false);
    ...
    <ScrollView style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          >
            <Text className="text-secondary-default text-4xl">
              {formatTime(currentTime)}
            </Text>
            <Text className="text-secondary-default mt-2">
              {t("calendar.tabs.target")} {time ? `${time}:00` : "00:00"}
            </Text>
          </View>
            ...
            <View className="bg-white rounded-2xl p-8 md:p-12 items-center">
              <View className="flex-col items-center justify-center">
                <Entypo
                  ...
                  className="mb-5"
                />
                <Text className="text-[#00B8D4] text-3xl font-extrabold mb-2">
                  {t("actions.designComplete")}
                </Text>
                <Text className="font-extrabold text-xl text-[#818181] mb-6">
                  {t("actions.takePhoto")}?
                </Text>
              </View>
